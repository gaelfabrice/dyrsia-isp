...
<head>
    ...
    <link rel="stylesheet" href="{$app_url}/ui/ui/styles/wifizones.customer.css?2025.5.22" />
...
.impersonation-bar {
    ...
    background: #fef3c7; color: #78350f; padding: 8px 16px;
    display: flex; align-items: center; justify-content: space-between;
    font-size: 13px; border-bottom: 1px solid #f59e0b;
}
.impersonation-bar a.btn { color: #78350f !important; font-weight: 800; }
body.impersonating-customer { padding-top: 42px; }
body.impersonating-customer .main-header { top: 42px !important; }
    </style>
    {/if}

</head>

<body class="hold-transition modern-skin-dark sidebar-mini{if $impersonation_active} impersonating-customer{/if}">
    <div class="wrapper">
        {if $impersonation_active}
