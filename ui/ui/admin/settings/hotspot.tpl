            ...
            <aside class="hs-wizard-preview">
                ...
                <div class="hs-phone">
                    ...
                    <div id="hs-preview-screen" class="hs-phone-screen" style="padding:0;">
                        <iframe id="hs-real-preview" src="{$app_url}/system/uploads/mikrotik_hotspot/login.html?title={$hs_title|escape:'url'}&routername={$hs_router|escape:'url'}&ts={$hs_login_preview_ts|default:0}" style="width:100%;height:100%;border:0;border-radius:36px;background:#0a0c15;" title="Aperçu login hotspot"></iframe>
                    </div>
                </div>
            </aside>
        </div>
