...
<form class="form-horizontal" method="post" role="form" action="{Text::url('')}settings/app-post"
    ...
    <input type="hidden" name="settings_panel" id="settings_panel" value="">
        ...
        <div id="collapseGeneral" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
            <div class="panel-body">
                <div class="alert alert-info">
                    <p><strong>{Lang::T('Database updates')}</strong></p>
                    <p>{Lang::T('After uploading new DYRSIA files, click Update Database to create missing tables and columns (Hotspot, FTTH mapping, login requests, etc.).')}</p>
                    <p>
                        <a class="btn btn-danger btn-sm" href="{$_url}plugin/hotspot_update&amp;db">
                ...
                <div class="form-group">
                    ...
                    <p class="help-block col-md-4"><a href="https://github.com/hotspotbilling/phpwifizones/wiki/Themes"
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <p class="help-block col-md-4"><a
                            href="https://github.com/hotspotbilling/phpwifizones/wiki/FreeRadius"
            ...
            <h4 class="panel-title">
                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion"
                    ...
                    <div class="btn-group pull-right">
                        <a class="btn btn-success btn-xs settings-test-btn" style="color: black;" href="javascript:void(0)" onclick="testTg(); return false;">Test TG</a>
                    </div>
                </a>
            </h4>
        </div>
        ...
        <div class="panel-heading" role="tab" id="SMSNotification">
            <h4 class="panel-title">
                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion"
                    ...
                    <div class="btn-group pull-right">
                        <a class="btn btn-success btn-xs settings-test-btn" style="color: black;" href="javascript:void(0)" onclick="testSms(); return false;">
                            {Lang::T('Test SMS')}
                        </a>
                    </div>
                </a>
        ...
        <div class="panel-heading" role="tab" id="WhatsappNotification">
            <h4 class="panel-title">
                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion"
                    ...
                    <div class="btn-group pull-right">
                        <a class="btn btn-success btn-xs settings-test-btn" style="color: black;" href="javascript:void(0)" onclick="testWa(); return false;">Test WA</a>
                    </div>
                </a>
            </h4>
        </div>
        ...
        <div class="panel-heading" role="tab" id="EmailNotification">
            <h4 class="panel-title">
                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion"
                    ...
                    <div class="btn-group pull-right">
                        <a class="btn btn-success btn-xs settings-test-btn" style="color: black;" href="javascript:void(0)" onclick="testEmail(); return false;">Test
                            Email</a>
                    </div>
                </a>
            </h4>
...
<script>
    (function() {
        var STORAGE_KEY = 'wifizone_settings_panel';

        window.wifizoneSettingsRememberPanel = function(panelId) {
            if (!panelId) return;
            try {
                sessionStorage.setItem(STORAGE_KEY, panelId);
            } catch (e) {}
            var field = document.getElementById('settings_panel');
            if (field) field.value = panelId;
            if (history.replaceState) {
                history.replaceState(null, '', '#' + panelId);
            }
        };

        window.wifizoneSettingsScrollToPanel = function(panelId) {
            var link = document.querySelector('#accordion [href="#' + panelId + '"]');
            if (link) {
                link.scrollIntoView({ behavior: 'smooth', block: 'start' });
            }
        };

        window.wifizoneSettingsOpenPanel = function(panelId, scroll) {
            ...
            wifizoneSettingsRememberPanel(panelId);
            if (scroll) {
                setTimeout(function() {
                    wifizoneSettingsScrollToPanel(panelId);
                }, 350);
            }
        };

        window.wifizoneSettingsTestNavigate = function(url, panelId) {
            wifizoneSettingsRememberPanel(panelId);
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            accordion.querySelectorAll('.settings-test-btn').forEach(function(btn) {
            ...
            if (typeof $ !== 'undefined') {
                $('#accordion').on('shown.bs.collapse', function(e) {
                    var id = e.target.id;
                    if (id) {
                        wifizoneSettingsRememberPanel(id);
                        wifizoneSettingsScrollToPanel(id);
                    }
                });
            }
            ...
            if (!panelId) {
                try {
                    panelId = sessionStorage.getItem(STORAGE_KEY) || '';
                } catch (e) {}
            }
            if (panelId && document.getElementById(panelId)) {
                wifizoneSettingsOpenPanel(panelId, true);
            }
        });
    })();

    function testWa() {
        var target = prompt("{Lang::T('Phone number')}\n{Lang::T('Save First before Test')}", "");
        if (target != null && target !== '') {
            wifizoneSettingsTestNavigate('{Text::url('settings/app&testWa=')}' + encodeURIComponent(target), 'collapseWhatsappNotification');
        }
    }
    ...
    function testSms() {
        var target = prompt("{Lang::T('Phone number')}\n{Lang::T('Save First before Test')}", "");
        if (target != null && target !== '') {
            wifizoneSettingsTestNavigate('{Text::url('settings/app&testSms=')}' + encodeURIComponent(target), 'collapseSMSNotification');
        }
    }

    function testEmail() {
        var target = prompt("{Lang::T('Email')}\n{Lang::T('Save First before Test')}", "");
        if (target != null && target !== '') {
            wifizoneSettingsTestNavigate('{Text::url('settings/app&testEmail=')}' + encodeURIComponent(target), 'collapseEmailNotification');
        }
    }

    function testTg() {
        wifizoneSettingsTestNavigate('{Text::url('settings/app&testTg=test')}', 'collapseTelegramNotification');
    }
</script>
