            ...
            <div class="panel panel-primary panel-hovered panel-stacked mb30">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <p class="help-block col-md-4"><small>
                                {Lang::T('If enabled, a daily ping runs via cron.php (once per day). Offline routers trigger a dashboard toast and WhatsApp when configured.')}
                            </small>
                        </p>
                    </div>
                    <div class="form-group" id="router_check">
                        <label class="col-md-3 control-label">{Lang::T('WhatsApp alert phone')}</label>
                        <div class="col-md-5">
                            <input type="text" name="router_alert_whatsapp_phone" class="form-control"
                                value="{$_c['router_alert_whatsapp_phone']}"
                                placeholder="ex: 0756888611 ou +2547...">
                        </div>
                        <p class="help-block col-md-4"><small>
                                {Lang::T('Number for offline router alerts. Leave empty to use the phone of the admin who added the router, or company phone in App Settings. Requires WhatsApp Gateway plugin or wa_url.')}
                            </small>
                        </p>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <p class="help-block col-md-4"><small>
                                ...
                                hotspot login
                                page.')} <a href="https://github.com/agstrxyz/phpwifizones-login-hotspot"
                                    target="_blank">Download
                                    phpwifizones-login-hotspot</a></small>
                        </p>
                    </div>
                    <div class="form-group">
