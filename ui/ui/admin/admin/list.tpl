                    ...
                    <table class="table table-bordered table-striped table-condensed">
                        <thead>
                            <tr>
                                ...
                                <th>{Lang::T('Email')}</th>
                                <th>{Lang::T('Type')}</th>
                                <th>{Lang::T('ISP / Business Name')}</th>
                        ...
                        <td>{if $ds['last_login']}{Lang::timeElapsed($ds['last_login'])}{/if}</td>
                                    <td>
                                        ...
                                        {if $_admin['user_type'] eq 'SuperAdmin' && $ds['user_type'] neq 'SuperAdmin'}
                                            <a href="{Text::url('impersonate/admin/', $ds['id'], '&token=', $csrf_token)}"
                                                class="btn btn-warning btn-xs"
                                                onclick="return confirm('{Lang::T('Login as this administrator?')}')">{Lang::T('Login as')}</a>
                                        {/if}
