                    ...
                    {if ($_admin['id']) neq ($d['id'])}
                        ...
                        <div class="form-group" id="ispTenantGroup">
                            ...
                            <div class="col-md-9">
                                ...
                                {elseif $user_isp}
                                    <input type="hidden" name="isp_business_name" value="{$user_isp['business_name']|escape}">
                                    <input type="text" class="form-control" value="{$user_isp['business_name']|escape}" readonly>
                                {else}
