                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="password" class="form-control" id="password" name="password"
                                value="{$d['password']|escape:'html'}" placeholder="{Lang::T('Leave blank to keep current password')}"
                                onmouseleave="this.type = 'password'"
                                onmouseenter="this.type = 'text'">
                            <p class="help-block">{Lang::T('API user from')} System → Users (not PPP/VPN login). Special characters are supported.</p>
                        </div>
                    </div>
                    <div class="form-group">
