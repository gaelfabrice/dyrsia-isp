                ...
                <div class="col-md-6">
                    <div class="box box-{if $package['status']=='on'}success{else}danger{/if}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4">
                                <a href="{Text::url('plan/edit/', $package['id'])}"
                                    class="btn btn-info btn-sm btn-block">{Lang::T('Edit Expiry')}</a>
                            </div>
                            <div class="col-xs-4">
...
<div class="row">
    ...
    <div class="col-xs-6 col-md-3">
        <a href="{Text::url('customers/login/', $d['id'], '&token=', $csrf_token)}"
            class="btn btn-warning btn-sm btn-block"
            onclick="return confirm('{Lang::T('Login as this customer?')}')">
