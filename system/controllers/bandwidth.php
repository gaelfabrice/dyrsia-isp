...
switch ($action) {
    ...
    run_hook('bulk_delete_bandwidth'); #HOOK
    ...
    if (isset($_POST['ids']) && is_array($_POST['ids'])) {
        ...
        foreach ($_POST['ids'] as $id) {
            ...
            ORM::for_table('tbl_bandwidth')
                ->where('id', $id)
                ->delete_many();
        }

        r2(getUrl('bandwidth/list'), 's', Lang::T('Selected data deleted successfully'));

    } else {
        r2(getUrl('bandwidth/list'), 'e', 'No items selected');
    }
