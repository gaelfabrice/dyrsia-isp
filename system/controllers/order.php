...
function order_scoped_router_query($user)
{
...
switch ($action) {
    ...
    case 'view':
        ...
        $router = order_scoped_router_query($user)->where('name', $trx['routers'])->find_one();
        ...
        switch (_post('custom')) {
            ...
            default:
                ...
                if ($plan['is_radius'] == '1') {
                    ...
                    $router = order_scoped_router_query($user)->where('enabled', '1')->find_one($routes['2']);
                } else {
                    $router['id'] = 0;
                    $router['name'] = 'balance';
                }
