    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="bs-callout bs-callout-warning well">
                ...
                <span class="text-muted">Change Auth Basic Password will change secret. No need to change whatsapp URL in wifizones with this. the plugin will work directly.</span>
            </div>
        </div>
    </div>
{/if}
...
<div class="bs-callout bs-callout-warning well">
    ...
    <p>If you put multiple number, it will send random to any existed phone number. even if it not logged in to
        WhatsApp.</p>
    <p><b>Empty Whatsapp Server URL in wifizones configuration</b>, this plugin will overide sending WhatsApp.</p>
