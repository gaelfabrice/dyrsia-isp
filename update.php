 ...
 *
 * This script is for updating wifizones
 **/
session_start();
include "config.php";
...
if (empty($update_url)) {
    $update_url = 'https://github.com/hotspotbilling/phpwifizones/archive/refs/heads/master.zip';
}
...
$file = pathFixer('system/cache/phpwifizones.zip');
$folder = pathFixer('system/cache/phpwifizones-' . basename($update_url, ".zip") . '/');
...
<body class="hold-transition skin-blue">
    <div class="container">
                    ...
                    <?php if ($continue || $step == 5) { ?>
                        ...
                        <?php } else if ($step == 5) { ?>
                            <div class="panel panel-success">
                                ...
                                <div class="panel-body">
                                    wifizones has been updated to Version <b><?= $version ?></b>
                                </div>
                            </div>
        ...
        <footer class="footer text-center">
            wifizones by <a href="https://github.com/hotspotbilling/phpwifizones" rel="nofollow noreferrer noopener" target="_blank">iBNuX</a>
        </footer>
    </div>
</body>
